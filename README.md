...
- add "models" folder from my repo and paste it into root "Yolox" directory : this contains the pre-trained weights downloaded from official site which you will need while training the model.
...
- Most important files to make changes - base_exp.py ( currently its for yolox_m, take weights for different model versions as required ), coco.py, demo.py, train.py
